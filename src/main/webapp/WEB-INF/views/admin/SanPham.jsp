									...
									<tbody>
										<c:forEach items="${listSP}" var="sp" varStatus="loop">
											<tr>
												...
												<td><c:if test="${sp.baoHanh==1}">6 tháng</c:if> <c:if
														test="${sp.baoHanh==2}">12 tháng</c:if> <c:if
														test="${sp.baoHanh==3}">24 tháng</c:if></td>

												<td>${sp.danhMucs.tenDanhMuc}</td>
											<td>${sp.phanTramGiam}%</td>
												<td>
													<div class="table-data-feature">

														<a href="${base}/admin1/sanpham/edit/${sp.id}"
														...
														<a href="${base}/admin1/sanpham/xemchitiet/${sp.id}"
